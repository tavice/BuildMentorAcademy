...
function HeroSection() {
  ...
  useEffect(() => {
    gsap.fromTo(
      ...
      { 
        opacity: 0.8,    // End state: fully visible
        duration: 10,   // Duration for opacity to reach 1 (appear)
        repeat: -1,    // Repeat indefinitely
        yoyo: true,    // Reverse the animation back to initial state
  ...
  return (
    <>
      <section className="bg-gradient-to-r from-blue-400 to-orange-400 text-white pb-20 rounded-lg">
        <svg
          data-name="Layer 1"
